...
{% hint style="success" %}
**Specs are published from CI.** Each reference above is generated from a spec in `specs/` in our docs repository. A merge that changes a spec republishes the reference automatically — see the [changelog](https://app.gitbook.com/s/mH0d2WOfwPMJtdaq2oGk/) for what shipped.
{% endhint %}
